...
type SeedResponse =
  | { message: string; skipped: true }
  | { message: string; skipped: false; seedCount: number; movies: any[] }

export const POST = withErrorHandling<SeedResponse>(async (_request, { supabase }) => {

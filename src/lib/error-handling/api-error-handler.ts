...
export class APIErrorHandler {
  ...
  static handle(
    ...
    fallbackErrorCode: (typeof ERROR_CODES)[keyof typeof ERROR_CODES] = ERROR_CODES.INTERNAL_ERROR
   ...
   */
  static success<T = any>(data: T, message?: string, metadata?: Record<string, any>): NextResponse {
